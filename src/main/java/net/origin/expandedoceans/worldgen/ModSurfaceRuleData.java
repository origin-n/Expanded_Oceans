...
public class ModSurfaceRuleData {
    private static final SurfaceRules.RuleSource DIRT = makeStateRule(Blocks.RAW_COPPER_BLOCK);
    private static final SurfaceRules.RuleSource GRASS_BLOCK = makeStateRule(Blocks.REDSTONE_BLOCK);
